    ...
    const links = [
        {
            ...
            href: 'https://www.linkedin.com/in/subash-guggilam-5b15b6219/',
            style: 'rounded-tr-md'
        },
        {
            id: 2,
        ...
        },
        {
            ...
            href: 'mailto:guggilamsubash@gmail.com',
        },
        {
            id: 4,
            child: (
            ...
            href: 'content://com.coloros.filemanager/root/storage/emulated/0/Download/SAISUBASH_GUGGILAM_Resume%20(2).txt',
            style: 'rounded-br-md',
            download: true,
        },
    ]
